<%-- 
    Document   : CadAlunoAlterar
    Created on : 29 de out de 2019, 19:52:37
...
<html>
    ...
    <body>
        ...
        <form name="frmCadastro" action="ControleAluno" method="POST">
            ...
            <table width="1024" border="1" align="center">
                <tr>
                    <td colspan="2" align="center">Alterar Dados de Aluno</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Nome</td>
                    <td><input type="text" name="txtNomeAluno" value="<%=o_Aluno.NomeAluno%>" /></td>
                </tr>
                <tr>
                    <td>Avaliação 1</td>
                    <td><input type="text" name="txtAvaliacao1" value="<%=o_Aluno.Avaliacao1%>" /></td>
                </tr>
                <tr>
                    <td>Avaliação 2</td>
                    <td><input type="text" name="txtAvaliacao2" value="<%=o_Aluno.Avaliacao2%>" /></td>
                </tr>
                <tr>
                    <td colspan="2" align="center">
                        <input type="submit" value="Cancelar" name="btnOperacao"/> &nbsp;&nbsp; <input type="submit" value="Alterar" name="btnOperacao"/>
                    </td>
                </tr>
            </table>
        </form>
